// Business logic utilities for flight analysis
// These are pure functions that can be used by both mock and real API implementations

/**
 * Get season type from a date
 */
export function getSeasonFromDate(date: Date): 'high' | 'normal' | 'low' {
...
export function calculateSavings(
  ...
  return highSeasonPrice - recommendedPrice
}
